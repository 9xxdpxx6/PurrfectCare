...
<form method="GET" class="mb-4">
    <div class="d-flex flex-wrap align-items-end gap-2">
        <div class="flex-grow-1" style="min-width:180px;">
            ...
            <input type="text" name="search" id="search" class="form-control" placeholder="Питомец, владелец, ветеринар или тип анализа..." value="{{ request('search') }}">
        </div>
        <div class="flex-grow-1" style="min-width:180px;">
                ...
                <div class="card-body h-100 flex-grow-1 d-flex flex-column flex-lg-row gap-3 align-items-lg-center">
                    <div class="d-flex flex-column h-100 flex-lg-row w-100 gap-3 align-items-lg-center">
                        ...
                        <div class="d-flex flex-row flex-lg-column gap-2 ms-lg-4 align-self-start text-nowrap">
                            <a href="{{ route('admin.lab-tests.show', $labTest) }}" class="btn btn-outline-info" title="Просмотр">
                                <span class="d-none d-lg-inline-block">Просмотр</span>
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('admin.lab-tests.edit', $labTest) }}" class="btn btn-outline-warning" title="Редактировать">
