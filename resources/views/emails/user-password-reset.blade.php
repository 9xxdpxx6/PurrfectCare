...
<head>
    ...
    <style>
        ...
        .password { background: #fff; border: 2px solid #28a745; padding: 15px; text-align: center; font-size: 20px; font-weight: bold; color: #28a745; margin: 20px 0; border-radius: 5px; font-family: monospace; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <ol>
                <li>Перейдите на страницу входа для клиентов</li>
                <li>Введите ваш email: <strong>{{ $userEmail }}</strong></li>
