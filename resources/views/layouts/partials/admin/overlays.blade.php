...
<!-- Оверлей профиля -->
<div id="profileOverlay" class="overlay-overlay" style="display: none;">
    <div class="overlay-content profile-overlay bg-body border rounded shadow overflow-hidden">
        <div class="p-3 border-bottom fw-semibold">
            <h6 class="mb-0">Профиль</h6>
        </div>
        <div class="px-3 py-2">
            <a href="{{ route('admin.employees.profile') }}" class="text-decoration-none d-block text-body mb-2">
